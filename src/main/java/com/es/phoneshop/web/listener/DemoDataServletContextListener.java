...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private void initProducts() throws ProductDaoException {
        ...
        productDao.save(new Product( "sgs", "Samsung Galaxy S", new BigDecimal("99.99"), usd, 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg", generateRandomPriceHistory()));
